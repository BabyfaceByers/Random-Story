...
OatmealCompanyLogo=pygame.image.load('OatmealLogo.png')
StorySurface.fill(black)
...
save3=False
def save1file():
    global save1arraypre,save1items,save1loc
    try:
        ...
        return False
def save2file():
    global save2arraypre,save2items,save2loc
    try:
        ...
        return False
def save3file():
    global save3arraypre,save3items,save3loc
    try:
...
def gamestart():
    ...
    while True:
        ...
        smallText=pygame.font.SysFont("arial",int(StorySurface.get_height()/32))
        textSurf,textRect=text_objects("1.1",smallText,black)
        StorySurface.blit(textSurf,textRect)
